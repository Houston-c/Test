...
<template>
  <base-drag :options="options" :cls="cls">
    <div class="vl-notify-content u_scrollBar" :style="contentStyle" :id="id"></div>
  </base-drag>
</template>

<script>
import helper from "./helper/helper.js";
import drag from "./components/iframe-drag/drag";
...
export default {
  ...
  computed: {
    contentStyle() {
      return {
        height: parseInt(this.options.area[1]) - 40 + "px",
        minHeight: "inherit",
        overflow: "auto"
      };
    }
